...
/**
 * Comrade Settings Class.
 * 
 * Retrieve, validate, and render field settings.
 *
 * @since  1.0.0
 */
class Settings {
	...
	public function get_settings_sections() {
		...
		// Don't forget to add fields for the section in the get_settings_fields() function
	...
	public function render_field( $args ) {
		...
		// Construct the key.
		$key 				= $this->engine->token . '-' . $args['section'] . '[' . $args['id'] . ']';
